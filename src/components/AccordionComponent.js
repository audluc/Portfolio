            ...
            <Row>
              <Col md={6}>
                <Card>
                  ...
                  <Card.Body>
                    ...
                    <Button
                      href="https://calm-ridge-31543.herokuapp.com/"
                      variant="warning"
                      block
                      size="lg"
                      type="button"
              ...
              <Col md={6}>
                <Card>
                  ...
                  <Button
                    href="https://ancient-earth-94263.herokuapp.com"
                    variant="warning"
                    block
                    size="lg"
                    type="button"
              ...
              <Col md={6}>
                <Card>
                  ...
                  <Card.Body>
                    ...
                    <Button
                      href="https://stormy-savannah-69546.herokuapp.com/"
                      variant="warning"
                      block
                      size="lg"
                      type="button"
              ...
              <Col md={6}>
                <Card>
                  ...
                  <Card.Body>
                    ...
                    <Button
                      href="https://ancient-journey-92327.herokuapp.com"
                      variant="warning"
                      block
                      size="lg"
                      type="button"
              ...
              <Col md={6}>
                <Card>
                  ...
                  <Card.Body>
                    ...
                    <Button
                      href="https://the-magic-dragon.github.io/The-Magic-D-Project-/"
                      variant="warning"
                      block
                      size="lg"
                      type="button"
              ...
              <Col md={6}>
                <Card>
                  ...
                  <Card.Body>
                    ...
                    <Button
                      href="https://audluc.github.io/Code-Quiz/"
                      variant="warning"
                      block
                      size="lg"
                      type="button"
              ...
              <Col md={6}>
                <Card>
                  ...
                  <Card.Body>
                    ...
                    <Button
                      href="https://audluc.github.io/Work-Day-Scheduler/"
                      variant="warning"
                      block
                      size="lg"
                      type="button"
